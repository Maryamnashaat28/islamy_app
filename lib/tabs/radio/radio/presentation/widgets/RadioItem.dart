...
class RadioItem extends StatefulWidget{
  ...
  final int index;
  RadioItem({required this.radio,required this.player,required this.index});
  @override
...
class _RadioItemState extends State<RadioItem> {
  ...
  Widget build(BuildContext context) {
    return CommonCard(name: "${widget.radio.name}",
        player: widget.player, url: widget.radio.url!);
