...
class Reciters {
  ...
  Reciters copyWith({  num? id,
    ...
    date: date ?? _date,
    moshaf: moshaf ?? _moshaf,
  );
  num? get id => _id;
  String? get name => _name;
  String? get letter => _letter;
  String? get date => _date;
  List<Moshaf>? get moshaf => _moshaf;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['date'] = _date;
    if (_moshaf != null) {
      map['moshaf'] = _moshaf?.map((v) => v.toJson()).toList();
    }
    return map;
  }
}